...
<body>
   <div class="container">
      ...
      <div class="border rounded mb-3 mt-5 p-3">
         <h4>File upload</h4>
         <form id="uploadForm" enctype="multipart/form-data" action="upload_file.php" method="POST">
   ...
   <?php include "./create_folder_dialog.php" ?>
   <?php include "./new_file_dialog.php" ?>
   <?php include "./upload_form_dialog.php" ?>
</body>
