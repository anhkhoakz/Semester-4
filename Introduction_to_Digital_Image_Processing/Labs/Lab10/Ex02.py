...
def gaussian_smoothing(image, kernel_size=5):
    ...
    Apply Gaussian smoothing to the input image.
        Parameters:
            image: An np.array compatible with plt.imshow.
            kernel_size (Default = 5): The size of the Gaussian kernel.
    """
...
def canny_detector(image, low_threshold=50, high_threshold=150):
    ...
    Apply Canny edge detection to the input image.
        Parameters:
            image: An np.array compatible with plt.imshow.
            low_threshold (Default = 50): The lower threshold for the hysteresis procedure.
            high_threshold (Default = 150): The higher threshold for the hysteresis procedure.
    """
...
def main():
    """
    Process the input video stream to detect lane lines.
    """
    process_video("./Lab10_test2.mp4", "white.mp4")
